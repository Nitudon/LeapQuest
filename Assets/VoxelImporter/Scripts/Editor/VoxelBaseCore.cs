    ...
    public abstract class VoxelBaseCore
    {
        ...
        public bool Create(string path)
        {
            ...
            }
            {
                ...
                {
                    Debug.LogErrorFormat("<color=green>[VoxelCharacteImporter]</color> It is unsupported file. <color=red>{0}</color>", path);
                    return false;
                }
            }
        ...
        public void SetTextureImporterSetting(string path, Texture2D atlasTexture)
        {
            ...
            #region Create
            {
                ...
                if ((voxelBase.enableFaceFlags & VoxelBase.Face.forward) != 0)
                {
                    for (int i = 0; i < faceAreaTable.forward.Count; i++)
                    {
                        ...
                        if (isHaveBoneWeight)
                        {
                            boneWeights.Add(GetBoneWeight(voxelBase.voxelData.voxels[voxelBase.voxelData.VoxelTableContains(faceArea.Get(VoxelBase.VoxelVertexIndex._XYZ))].position, VoxelBase.VoxelVertexIndex._XYZ));
                            boneWeights.Add(GetBoneWeight(voxelBase.voxelData.voxels[voxelBase.voxelData.VoxelTableContains(faceArea.Get(VoxelBase.VoxelVertexIndex._X_YZ))].position, VoxelBase.VoxelVertexIndex._X_YZ));
                            boneWeights.Add(GetBoneWeight(voxelBase.voxelData.voxels[voxelBase.voxelData.VoxelTableContains(faceArea.Get(VoxelBase.VoxelVertexIndex.X_YZ))].position, VoxelBase.VoxelVertexIndex.X_YZ));
                            boneWeights.Add(GetBoneWeight(voxelBase.voxelData.voxels[voxelBase.voxelData.VoxelTableContains(faceArea.Get(VoxelBase.VoxelVertexIndex.XYZ))].position, VoxelBase.VoxelVertexIndex.XYZ));
                        }
                    }
                }
                #endregion
                ...
                if ((voxelBase.enableFaceFlags & VoxelBase.Face.up) != 0)
                {
                    for (int i = 0; i < faceAreaTable.up.Count; i++)
                    {
                        ...
                        if (isHaveBoneWeight)
                        {
                            boneWeights.Add(GetBoneWeight(voxelBase.voxelData.voxels[voxelBase.voxelData.VoxelTableContains(faceArea.Get(VoxelBase.VoxelVertexIndex._XY_Z))].position, VoxelBase.VoxelVertexIndex._XY_Z));
                            boneWeights.Add(GetBoneWeight(voxelBase.voxelData.voxels[voxelBase.voxelData.VoxelTableContains(faceArea.Get(VoxelBase.VoxelVertexIndex._XYZ))].position, VoxelBase.VoxelVertexIndex._XYZ));
                            boneWeights.Add(GetBoneWeight(voxelBase.voxelData.voxels[voxelBase.voxelData.VoxelTableContains(faceArea.Get(VoxelBase.VoxelVertexIndex.XYZ))].position, VoxelBase.VoxelVertexIndex.XYZ));
                            boneWeights.Add(GetBoneWeight(voxelBase.voxelData.voxels[voxelBase.voxelData.VoxelTableContains(faceArea.Get(VoxelBase.VoxelVertexIndex.XY_Z))].position, VoxelBase.VoxelVertexIndex.XY_Z));
                        }
                    }
                }
                #endregion
                ...
                if ((voxelBase.enableFaceFlags & VoxelBase.Face.right) != 0)
                {
                    for (int i = 0; i < faceAreaTable.right.Count; i++)
                    {
                        ...
                        if (isHaveBoneWeight)
                        {
                            boneWeights.Add(GetBoneWeight(voxelBase.voxelData.voxels[voxelBase.voxelData.VoxelTableContains(faceArea.Get(VoxelBase.VoxelVertexIndex.X_Y_Z))].position, VoxelBase.VoxelVertexIndex.X_Y_Z));
                            boneWeights.Add(GetBoneWeight(voxelBase.voxelData.voxels[voxelBase.voxelData.VoxelTableContains(faceArea.Get(VoxelBase.VoxelVertexIndex.XY_Z))].position, VoxelBase.VoxelVertexIndex.XY_Z));
                            boneWeights.Add(GetBoneWeight(voxelBase.voxelData.voxels[voxelBase.voxelData.VoxelTableContains(faceArea.Get(VoxelBase.VoxelVertexIndex.XYZ))].position, VoxelBase.VoxelVertexIndex.XYZ));
                            boneWeights.Add(GetBoneWeight(voxelBase.voxelData.voxels[voxelBase.voxelData.VoxelTableContains(faceArea.Get(VoxelBase.VoxelVertexIndex.X_YZ))].position, VoxelBase.VoxelVertexIndex.X_YZ));
                        }
                ...
                if ((voxelBase.enableFaceFlags & VoxelBase.Face.left) != 0)
                {
                    for (int i = 0; i < faceAreaTable.left.Count; i++)
                    {
                        ...
                        {
                            boneWeights.Add(GetBoneWeight(voxelBase.voxelData.voxels[voxelBase.voxelData.VoxelTableContains(faceArea.Get(VoxelBase.VoxelVertexIndex._X_YZ))].position, VoxelBase.VoxelVertexIndex._X_YZ));
                            boneWeights.Add(GetBoneWeight(voxelBase.voxelData.voxels[voxelBase.voxelData.VoxelTableContains(faceArea.Get(VoxelBase.VoxelVertexIndex._X_Y_Z))].position, VoxelBase.VoxelVertexIndex._X_Y_Z));
                            boneWeights.Add(GetBoneWeight(voxelBase.voxelData.voxels[voxelBase.voxelData.VoxelTableContains(faceArea.Get(VoxelBase.VoxelVertexIndex._XY_Z))].position, VoxelBase.VoxelVertexIndex._XY_Z));
                            boneWeights.Add(GetBoneWeight(voxelBase.voxelData.voxels[voxelBase.voxelData.VoxelTableContains(faceArea.Get(VoxelBase.VoxelVertexIndex._XYZ))].position, VoxelBase.VoxelVertexIndex._XYZ));
                        }
                    }
        ...
        protected VoxelData.FaceAreaTable CreateFaceArea_LowTexture(VoxelData.Voxel[] voxels)
        {
            Func<int, VoxelBase.Face, VoxelData.FaceArea> CalcFaceX = (baseIndex, flag) =>
            {
                ...
                for (int i = z - 1; ; i--)
                {
                    ...
                    if (index < 0 || voxelBase.voxelData.voxels[index].palette != palette || voxelBase.GetMaterialIndexTable(x, y, i) != material ||
                ...
                for (int i = y - 1; ; i--)
                {
                    ...
                    for (int j = area.min.z; j <= area.max.z; j++)
                    {
                        ...
                        if (index < 0 || voxelBase.voxelData.voxels[index].palette != palette || voxelBase.GetMaterialIndexTable(x, i, j) != material ||
            ...
            Func<int, VoxelBase.Face, VoxelData.FaceArea> CalcFaceY = (baseIndex, flag) =>
            {
                ...
                for (int i = x - 1; ; i--)
                {
                    ...
                    for (int j = area.min.z; j <= area.max.z; j++)
                    {
                        ...
                        if (index < 0 || voxelBase.voxelData.voxels[index].palette != palette || voxelBase.GetMaterialIndexTable(i, y, j) != material ||
                            (voxelDoneFaces[index] & flag) != 0 || !IsCombineVoxelFace(voxels[baseIndex].position, voxelBase.voxelData.voxels[index].position, flag)) { r = false; break; }
                    }
                    if (!r) break;
                    area.min.x = i;
            ...
            Func<int, VoxelBase.Face, VoxelData.FaceArea> CalcFaceZ = (baseIndex, flag) =>
            {
                ...
                for (int i = y - 1; ; i--)
                {
                    ...
                    if (index < 0 || voxelBase.voxelData.voxels[index].palette != palette || voxelBase.GetMaterialIndexTable(x, i, z) != material ||
                        (voxelDoneFaces[index] & flag) != 0 || !IsCombineVoxelFace(voxels[baseIndex].position, voxelBase.voxelData.voxels[index].position, flag)) break;
                    area.min.y = i;
                }
                //down
                ...
                for (int i = x - 1; ; i--)
                {
                    ...
                    for (int j = area.min.y; j <= area.max.y; j++)
                    {
                        ...
                        if (index < 0 || voxelBase.voxelData.voxels[index].palette != palette || voxelBase.GetMaterialIndexTable(i, j, z) != material ||
                            (voxelDoneFaces[index] & flag) != 0 || !IsCombineVoxelFace(voxels[baseIndex].position, voxelBase.voxelData.voxels[index].position, flag)) { r = false; break; }
                    }
                    if (!r) break;
                    area.min.x = i;
        ...
        public bool IsVoxelVisible(IntVector3 pos)
        {
            ...
            if (voxelBase.voxelData.voxels[index].visible != 0) return true;
