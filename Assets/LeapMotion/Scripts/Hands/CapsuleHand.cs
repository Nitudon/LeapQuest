...
namespace Leap.Unity {
  ...
  public class CapsuleHand : IHandModel {
    ...
    private static Color[] _leftColorList = { new Color(0.0f, 0.0f, 1.0f), new Color(0.0f, 0.0f, 0.1f), new Color(0.0f, 0.0f, 0.1f) };
    private static Color[] _rightColorList = { new Color(1.0f, 0.0f, 0.0f), new Color(1.0f, 0.0f, 0.0f), new Color(1.0f, 0.0f, 0.0f) };
